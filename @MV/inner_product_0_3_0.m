function r=inner_product_0_3_0(a,b)


% INNER_PRODUCT_0_3_0 - Computes the inner product of two multivectors in the (0,3,0) algebra.
%
% Syntax:
...
%   a = MV([...], [0, 3, 0]);
%   b = MV([...], [0, 3, 0]);
%   r = inner_product_0_3_0(a.vector, b.vector);
