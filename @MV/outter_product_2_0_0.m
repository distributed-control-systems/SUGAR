function r=outter_product_2_0_0(a,b)


% OUTTER_PRODUCT_2_0_0 - Computes the outter product of two multivectors in the (2,0,0) algebra.
%
% Syntax:
...
%   a = MV([...], [2,0,0]);
%   b = MV([...], [2,0,0]);
%   r = outter_product_2_0_0(a.vector, b.vector);
