function r=outter_product_0_1_1(a,b)


% OUTTER_PRODUCT_0_1_1 - Computes the outter product of two multivectors in the (0,1,1) algebra.
%
% Syntax:
...
%   a = MV([...], [0,1,1]);
%   b = MV([...], [0,1,1]);
%   r = outter_product_0_1_1(a.vector, b.vector);
