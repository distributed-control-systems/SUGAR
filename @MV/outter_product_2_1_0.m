function r=outter_product_2_1_0(a,b)


% OUTTER_PRODUCT_2_1_0 - Computes the outter product of two multivectors in the (2,1,0) algebra.
%
% Syntax:
...
%   a = MV([...], [2,1,0]);
%   b = MV([...], [2,1,0]);
%   r = outter_product_2_1_0(a.vector, b.vector);
