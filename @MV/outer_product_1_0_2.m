function r=outer_product_1_0_2(a,b)


% OUTTER_PRODUCT_1_0_2 - Computes the outer product of two multivectors in the (1,0,2) algebra.
%
% Syntax:
...
%   a = MV([...], [1,0,2]);
%   b = MV([...], [1,0,2]);
%   r = outer_product_1_0_2(a.vector, b.vector);
