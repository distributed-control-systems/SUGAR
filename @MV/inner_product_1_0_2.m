function r=inner_product_1_0_2(a,b)


% INNER_PRODUCT_1_0_2 - Computes the inner product of two multivectors in the (1,0,2) algebra.
%
% Syntax:
...
%   a = MV([...], [1, 0, 2]);
%   b = MV([...], [1, 0, 2]);
%   r = inner_product_1_0_2(a.vector, b.vector);
