function r=inner_product_1_2_0(a,b)


% INNER_PRODUCT_1_2_0 - Computes the inner product of two multivectors in the (1,2,0) algebra.
%
% Syntax:
...
%   a = MV([...], [1, 2, 0]);
%   b = MV([...], [1, 2, 0]);
%   r = inner_product_1_2_0(a.vector, b.vector);
