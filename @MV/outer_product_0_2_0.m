function r=outer_product_0_2_0(a,b)


% OUTTER_PRODUCT_0_2_0 - Computes the outer product of two multivectors in the (0,2,0) algebra.
%
% Syntax:
...
%   a = MV([...], [0,2,0]);
%   b = MV([...], [0,2,0]);
%   r = outer_product_0_2_0(a.vector, b.vector);
