function r=outer_product_0_1_2(a,b)


% OUTTER_PRODUCT_0_1_2 - Computes the outer product of two multivectors in the (0,1,2) algebra.
%
% Syntax:
...
%   a = MV([...], [0,1,2]);
%   b = MV([...], [0,1,2]);
%   r = outer_product_0_1_2(a.vector, b.vector);
