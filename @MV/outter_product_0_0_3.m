function r=outter_product_0_0_3(a,b)


% OUTTER_PRODUCT_0_0_3 - Computes the outter product of two multivectors in the (0,0,3) algebra.
%
% Syntax:
...
%   a = MV([...], [0,0,3]);
%   b = MV([...], [0,0,3]);
%   r = outter_product_0_0_3(a.vector, b.vector);
