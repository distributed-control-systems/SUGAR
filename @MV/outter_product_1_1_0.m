function r=outter_product_1_1_0(a,b)


% OUTTER_PRODUCT_1_1_0 - Computes the outter product of two multivectors in the (1,1,0) algebra.
%
% Syntax:
...
%   a = MV([...], [1,1,0]);
%   b = MV([...], [1,1,0]);
%   r = outter_product_1_1_0(a.vector, b.vector);
