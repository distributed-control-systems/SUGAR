function r=outter_product_0_0_0(a,b)


% OUTTER_PRODUCT_0_0_0 - Computes the outter product of two multivectors in the (0,0,0) algebra.
%
% Syntax:
...
%   a = MV([...], [0,0,0]);
%   b = MV([...], [0,0,0]);
%   r = outter_product_0_0_0(a.vector, b.vector);
