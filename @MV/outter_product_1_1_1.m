function r=outter_product_1_1_1(a,b)


% OUTTER_PRODUCT_1_1_1 - Computes the outter product of two multivectors in the (1,1,1) algebra.
%
% Syntax:
...
%   a = MV([...], [1,1,1]);
%   b = MV([...], [1,1,1]);
%   r = outter_product_1_1_1(a.vector, b.vector);
